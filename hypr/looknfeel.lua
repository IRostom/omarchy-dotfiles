...
-- macOS-style frosted glass for the top bar. Omarchy ships with blur off
-- (see $OMARCHY_PATH/default/hypr/looknfeel.lua), so it's turned back on
-- here just for this. The bar chips (irostom.bar clone) paint themselves
-- semi-transparent; this rule blurs the desktop behind that translucency
-- instead of behind fully opaque chips.
hl.config({
  decoration = {
    blur = {
      enabled = true,
